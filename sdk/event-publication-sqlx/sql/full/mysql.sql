CREATE TABLE `sdk_event_publication_record` (
    `application_id` VARCHAR(255) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    `publisher_id` VARCHAR(255) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    ...
    KEY `idx_sdk_event_publication_recovery` (`application_id`, `publisher_id`, `recover_after`, `idempotency_key`),
